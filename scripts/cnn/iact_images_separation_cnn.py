...
for p in range(len(particle_type)):
    for r in range(len(run[p])):
        ...
        input_filename = f"dm-finder/cnn/iact_images/input/{particle_type[p]}/{image_type}/" + run_filename + "_images.h5"
...
plt.yscale("log")
plt.legend()
plt.savefig(f"dm-finder/cnn/iact_images/results/{image_type}/separation/total_energy_distribution.png")
plt.close()
...
#     plt.savefig(f"dm-finder/cnn/iact_images/results/{image_type}/separation/example_{i}.png")
#     plt.close()
...
history_path = f"dm-finder/cnn/iact_images/history/{image_type}/separation/" + "history.csv"
...
model_path = f"dm-finder/cnn/iact_images/model/{image_type}/separation/" + "model.h5"
...
plt.yscale("log")
plt.legend()
plt.savefig(f"dm-finder/cnn/iact_images/results/{image_type}/separation/gammaness.png")
plt.close()
...
# path_output = f'dm-finder/cnn/iact_images/output/{image_type}/separation/'
...
# path = f"dm-finder/cnn/iact_images/results/{image_type}/separation/"
